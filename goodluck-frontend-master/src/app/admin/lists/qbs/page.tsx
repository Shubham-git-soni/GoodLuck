...
export default function AdminQBListPage() {
  ...
  if (isLoading) {
    return (
      <PageContainer>
        <PageHeader title="All QBs" description="Manage all Quick Batch Sellers" />
  ...
  return (
    <PageContainer>
      ...
      <MobileSheet
        ...
        title="Add New QB"
        description="Fill in the school details for the new Quick Batch Seller"
        footer={
      ...
      <Dialog open={isDesktopDialogOpen} onOpenChange={(o) => { setIsDesktopDialogOpen(o); if (!o) resetForm(); }}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Add New QB</DialogTitle>
            <DialogDescription>Fill in the school details for the new Quick Batch Seller.</DialogDescription>
          </DialogHeader>
      ...
      <div className="md:hidden mb-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold tracking-tight">All QBs</h1>
            <p className="text-xs text-muted-foreground mt-0.5">{qbs.length} total QBs</p>
          </div>
      ...
      <div className="hidden md:block">
        <PageHeader
          title="All QBs"
          description={`${qbs.length} total Quick Batch Sellers`}
          action={
