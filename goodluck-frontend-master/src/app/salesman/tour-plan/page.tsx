    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <Select value={selectedObjective} onValueChange={setSelectedObjective}>
          <SelectTrigger><SelectValue placeholder="Select visit objective" /></SelectTrigger>
          <SelectContent>
  ...
  return (
    <PageContainer>
      ...
      <MobileSheet
        ...
        description="Select a school, objective, and date"
        footer={
      ...
      {plannedVisits.length === 0 ? (
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-muted-foreground text-center">No visits planned yet. Add schools to your tour plan.</p>
          </CardContent>
        </Card>
      ) : (
        <>
                        ...
                        <CardContent className="p-4">
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              ...
                              <Badge variant="secondary" className="text-xs">{visit.objective}</Badge>
                            </div>
                            <Button variant="ghost" size="icon" onClick={() => handleRemoveSchool(visit.id)}>
