                                                            ...
                                                            return (
                                                                <td
                                                                    ...
                                                                    className={cn(
                                                                        ...
                                                                        col.pinned === "left" && "sticky left-0 bg-card group-hover:bg-muted z-[5]",
                                                                        col.pinned === "left" && isSel && "bg-primary/10 group-hover:bg-primary/15",
                                                                        col.pinned === "right" && "sticky right-0 bg-card group-hover:bg-muted z-[5]",
                                                                        col.pinned === "right" && isSel && "bg-primary/10 group-hover:bg-primary/15",
                                                                        isPinned && col.pinned === "left" && "bg-amber-50 dark:bg-amber-950/20",
                                                                        isPinned && col.pinned === "right" && "bg-amber-50 dark:bg-amber-950/20"
                                                                    )}
                                                                    style={colWidths[col.key] ? { width: colWidths[col.key] } : {}}
                                                                    title={tooltip}
                                                                >
